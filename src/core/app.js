...
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/core/config.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/utils/html.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/services/event-bus.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/services/storage-service.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/services/notification-service.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/ui/window.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/services/purchase-lot-service.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/services/portfolio-service.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/services/statistics-service.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/services/flip-store.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/modules/dashboard/dashboard.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/modules/analytics/analytics.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/modules/flip-entry/flip-entry.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/modules/open-purchases/open-purchases.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/modules/backup/backup.js?v=0.6.1
// @require      https://raw.githubusercontent.com/MonsterSnack/Flip-Tracker-Pro/main/src/modules/saved-flips/saved-flips.js?v=0.6.1
// @grant        none
// ==/UserScript==
...
(function bootstrapFlipTrackerPro() {
  ...
  const styles = `
    ...
    #${config.rootId} .ftp-window[data-dragging="true"] .ftp-titlebar { cursor: grabbing; }
    ...
    #${config.rootId} .ftp-title-group { gap: 1px; }
    #${config.rootId} .ftp-title-button { display: flex; align-items: center; width: fit-content; border: 0; background: transparent; color: #f4f6fb; cursor: pointer; font: inherit; font-size: 13px; font-weight: 700; letter-spacing: 0; line-height: 1.15; padding: 0; text-align: left; }
    #${config.rootId} .ftp-title-button:hover { color: #4f8cff; }
    #${config.rootId} .ftp-version { color: #9aa3b2; font-size: 10px; line-height: 1; }
    #${config.rootId} .ftp-window-actions, #${config.rootId} .ftp-flip-row, #${config.rootId} .ftp-row-actions, #${config.rootId} .ftp-chart-label { display: flex; align-items: center; }
    #${config.rootId} .ftp-window-actions { gap: 4px; }
    #${config.rootId} .ftp-window-button { width: 22px; height: 20px; border: 1px solid #313744; border-radius: 5px; background: #20242d; color: #f4f6fb; cursor: pointer; font: inherit; font-size: 11px; line-height: 1; padding: 0; }
    #${config.rootId} .ftp-window-button:hover { border-color: #4f8cff; background: #263145; }
    ...
    #${config.rootId} [data-saved-flips-controls], #${config.rootId} .ftp-backup-actions, #${config.rootId} .ftp-subheading { margin-top: 10px; }
    #${config.rootId} .ftp-stat { background: #181b22; }
    #${config.rootId} .ftp-stat span, #${config.rootId} .ftp-field span, #${config.rootId} .ftp-profit-preview span, #${config.rootId} .ftp-profit-preview small, #${config.rootId} .ftp-saved-flip-main span { color: #9aa3b2; font-size: 11px; }
    #${config.rootId} .ftp-field span { font-weight: 700; }
    ...
    #${config.rootId} .ftp-row-actions { gap: 6px; }
    #${config.rootId} .ftp-chart-label { justify-content: space-between; gap: 8px; }
    #${config.rootId} .ftp-chart-label span { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    ...
    #${config.rootId} .ftp-form-actions { gap: 8px; }
    ...
    #${config.rootId} .ftp-status { margin-top: 8px; font-weight: 700; }
    #${config.rootId} .ftp-primary-button, #${config.rootId} .ftp-secondary-button, #${config.rootId} .ftp-danger-button { border: 0; border-radius: 6px; color: #ffffff; cursor: pointer; font: inherit; font-size: 12px; font-weight: 700; padding: 9px 10px; }
    #${config.rootId} .ftp-primary-button { background: #4f8cff; }
    #${config.rootId} .ftp-primary-button:hover { background: #2f6ee8; }
    #${config.rootId} .ftp-secondary-button { background: #313744; color: #f4f6fb; }
    #${config.rootId} .ftp-secondary-button:hover { background: #3d4657; }
    #${config.rootId} .ftp-danger-button { background: #3a2024; color: #ffb3b3; font-size: 11px; padding: 6px 8px; }
    #${config.rootId} .ftp-danger-button:hover { background: #5a2930; }
    ...
    #${config.rootId} .ftp-notification strong { font-size: 12px; text-transform: capitalize; }
    #${config.rootId} .ftp-notification span { color: #9aa3b2; font-size: 11px; line-height: 1.4; }
    #${config.rootId} .ftp-notification[data-type="success"] { border-color: #2f7d5a; }
    #${config.rootId} .ftp-notification[data-type="error"] { border-color: #8a3a43; }
    #${config.rootId} .ftp-notification[data-type="warning"] { border-color: #8a713a; }
    #${config.rootId} .ftp-notification[data-type="info"] { border-color: #4f8cff; }
  `;
  ...
  function getPortfolio(data) {
    return portfolioService && typeof portfolioService.calculate === 'function'
      ? portfolioService.calculate(getPurchaseLots(data), data.settings)
      : [];
  }
  ...
  function getPortfolioSummary(portfolio) {
    return portfolioService && typeof portfolioService.summarize === 'function'
      ...
      : { estimatedProfit: 0, itemCount: 0, openQuantity: 0, totalInvestment: 0 };
  }
  ...
  function getRouteHtml() {
    ...
    const openPurchasesHtml = renderModule(openPurchases, { purchaseLots }, 'Purchases unavailable');
